    ...
    <div className="mt-3">
      {!isLoading && !isError && stations.length > 0 && (
        <Tabs
          ...
          className="flex w-full overflow-x-auto no-scrollbar !bg-primary-accent/20 dark:!bg-[#46566a] !rounded-lg !p-2 [&_.MuiTabs-flexContainer]:justify-between [&_.MuiTabs-flexContainer]:gap-2 [&_.MuiTabs-indicator]:hidden"
          variant="scrollable"
          scrollButtons={false}
        >
